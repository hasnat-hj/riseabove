      ...
      <div className="container h-full mx-auto">
        <div className="grid h-full items-center gap-4 md:grid-cols-12">
          <div className="col-span-6 flex h-full flex-col items-center justify-center py-10 md:items-start md:py-20 xl:col-span-4">
            <h3 className="text-jacarta-700 font-bold font-display mb-6 text-center text-5xl dark:text-white md:text-left lg:text-6xl xl:text-7xl" style={{fontSize:"2.25rem"}}>
            Rise Artist Collective Curated Marketplace
            </h3>
            <p className="dark:text-jacarta-200 mb-8 text-center text-lg md:text-left">
            Welcome To The Rise Artist Collective Curated Marketplace On The Rise Eco Platform! Largest Digital Marketplace For Crypto Collectibles And Non-Fungible Tokens
            </p>
